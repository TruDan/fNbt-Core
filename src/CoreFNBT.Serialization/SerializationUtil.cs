...
namespace fNbt.Serialization {
    ...
    internal static class SerializationUtil {
        ...
        public static bool IsDirectlyMappedType(Type type) {
            return !type.GetTypeInfo().IsGenericType && // to catch Nullable<T>
        ...
        public static Type GetGenericInterfaceImpl(Type concreteType, Type genericInterface) {
            if (genericInterface.GetTypeInfo().IsGenericTypeDefinition) {
                if (concreteType.GetTypeInfo().IsGenericType && concreteType.GetGenericTypeDefinition() == genericInterface) {
                    ...
                    return concreteType.GetInterfaces()
                                       .SingleOrDefault(x => x.GetTypeInfo().IsGenericType &&
        ...
        public static Type GetStringIDictionaryImpl(Type concreteType) {
            return concreteType.GetInterfaces().FirstOrDefault(
                iFace => iFace.GetTypeInfo().IsGenericType &&
        ...
        public static MethodInfo GetGenericInterfaceMethodImpl(Type concreteType, Type genericInterface,
            ...
            if (impl.GetTypeInfo().IsInterface) {
                ...
                // may cause ambiguity.
                InterfaceMapping implMap =  concreteType.GetTypeInfo().GetRuntimeInterfaceMap(concreteType);
